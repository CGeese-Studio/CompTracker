...
var totalActs: Double = (newActs + upgrade + tablet + prepaid + spc + mbb) //Total of all activations combined
var totalActComp: Double = (totalActs * 0.75) //Total activation Comp value
